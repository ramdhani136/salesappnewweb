...
export const AssesmentPage: React.FC = (): any => {
  ...
  const metaData = {
    title: "Assesment - Sales App Ekatunggal",
    description: "Halaman assesment sales web system",
  };
        ...
        {!loading ? (
          <>
            ...
            <TableComponent
              ...
              filter={filter}
              setFilter={setFilter}
              localStorage={LocalStorageType.FILTERASSESMENT}
              onRefresh={onRefresh}
            />
          </>
        ) : (
