    ...
    <div className="w-full flex flex-col">
      ...
      <ul className="w-full h-automx-3 float-left">
        <li
          ...
          className="list-none ml-3 items-center flex border rounded-md bg-white float-left w-[32%] shadow-md px-3 py-5 cursor-pointer hover:px-5 duration-100 hover:py-6"
        >
        ...
        >
          <EventAvailableIcon style={{ fontSize: 16 }} />
          <h4 className="text-gray-800 font-semibold ml-1">
            Customer Assesment
          </h4>
        </li>
      </ul>
